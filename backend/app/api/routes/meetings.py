...
@router.post("/meetings/transcribe", response_model=TranscribeResponse)
async def transcribe_meeting(
    ...
    This endpoint only performs transcription and returns the transcript with speaker labels.
    """
    ...
    try:
        ...
        return TranscribeResponse(
            transcript_text=speech_res.transcript_text,
            segments=speech_res.segments,
            transcription_model=speech_res.transcription_model,
            trim=trim_info,
        )
...
@router.post("/meetings/summarize", response_model=SummarizeResponse)
async def summarize_transcript(req: SummarizeRequest):
    """
    Summarize a transcript into structured meeting notes.
    This endpoint accepts a transcript text and returns a summary with participants,
    ...
    return SummarizeResponse(
        ...
        llm_model=summary_res.llm_model,
    )
